...
export const essayApi = {
  submit: (text: string, assignmentId?: string) => api.post("/api/essays", { text, assignmentId }),
...
export const studentApi = {
  ...
  submitAssignment: (assignmentId: string, text: string) => api.post(`/api/student/assignments/${assignmentId}/submit`, { text }),
};
