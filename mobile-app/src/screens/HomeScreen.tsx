...
const TASK_CARDS = [
  {
    ...
    description: "Argue a position, discuss a topic, or evaluate ideas. 250+ words.",
    icon: "✍️",
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.ctaText}>
            ...
            <Text style={styles.ctaSubtitle}>Get AI feedback in under a minute</Text>
          </View>
        ...
        <View style={styles.taskRow}>
          {TASK_CARDS.map((card) => (
            <TouchableOpacity
              ...
              onPress={() => router.push({ pathname: "/essay/input", params: { taskType: card.type } })}
              activeOpacity={0.8}
            >
...
const styles = StyleSheet.create({
  ...
  header:      { backgroundColor: Colors.primary, paddingTop: 56, paddingBottom: 28, paddingHorizontal: Spacing.xl },
  ...
  mainCta:     { flexDirection: "row", alignItems: "center", backgroundColor: Colors.primary, borderRadius: Radius.lg, padding: Spacing.xl, marginBottom: Spacing.xl, ...Shadow.md },
  ...
  taskRow:     { flexDirection: "row", gap: Spacing.md, marginBottom: Spacing.xl },
  taskCard:    { flex: 1, backgroundColor: Colors.surface, borderRadius: Radius.lg, padding: Spacing.lg, borderWidth: 1.5, ...Shadow.sm },
  taskIcon:    { width: 44, height: 44, borderRadius: Radius.md, alignItems: "center", justifyContent: "center", marginBottom: Spacing.sm },
