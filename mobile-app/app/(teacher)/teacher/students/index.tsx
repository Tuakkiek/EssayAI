...
export default function TeacherStudentsScreen() {
  ...
  const fetchStudents = useCallback(async (showRefresh = false) => {
    ...
    try {
      ...
      Alert.alert("Lá»—i", "KhÃ´ng thá»ƒ táº£i danh sÃ¡ch há»c sinh. Vui lÃ²ng thá»­ láº¡i.");
    } finally {
      setIsLoading(false);
    ...
    >
      ...
      <View style={styles.info}>
        ...
        <View style={styles.stats}>
          <Text style={styles.stat}>ðŸ“ {item.totalEssays} bÃ i</Text>
          {item.averageBand != null && (
            <Text style={styles.stat}>â­ TB {item.averageBand.toFixed(1)}</Text>
          )}
        </View>
      </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Há»c sinh</Text>
        ...
        ListEmptyComponent={
          <View style={styles.center}>
            ...
            <Text style={styles.emptyText}>
              {search ? "KhÃ´ng tÃ¬m tháº¥y há»c sinh" : "ChÆ°a cÃ³ há»c sinh"}
            </Text>
          </View>
        }
      />
