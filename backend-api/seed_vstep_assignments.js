...
const assignments = [
    // 1. Công nghệ & Giáo dục
    {
        ...
        prompt: "In recent years, many parents have let their children use computers from early ages. Some people say that it is good for children. However, some others hold the view that it has negative effects. Discuss both views and give your opinion.",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Discuss both views + opinion. Thí sinh phải trình bày CẢ HAI quan điểm (tốt và xấu) rồi đưa ra ý kiến cá nhân có lý lẽ. Không được chỉ viết một chiều.",
    },
    // 2. Công việc & Sự nghiệp
    {
        ...
        prompt: "Many people believe that having a high salary is more important than job satisfaction. To what extent do you agree or disagree with this statement?",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Opinion essay (Agree/Disagree). Thí sinh nêu rõ mức độ đồng ý/không đồng ý và lập luận nhất quán trong toàn bài. Được phép đồng ý một phần (partially agree).",
    },
    // 3. Môi trường & Năng lượng
    {
        ...
        prompt: "The development of energy (solar, wind, nuclear) has both positive and negative impacts on the environment. Write an essay to discuss these impacts.",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Discussion essay (cả hai mặt tích cực và tiêu cực). Thí sinh cần đề cập đến ít nhất 2 trong số 3 loại năng lượng được nêu trong đề (mặt trời, gió, hạt nhân).",
    },
    // 4. Đô thị hóa & Di cư
    {
        ...
        prompt: "Nowadays, more and more people are moving from urban areas to rural areas to live. What are the advantages and disadvantages of this trend?",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Advantages & Disadvantages. Thí sinh phải trình bày RÕ RÀNG cả ưu điểm lẫn nhược điểm. Độ dài 2 mặt cần tương đối cân bằng.",
    },
    // 5. Kỹ năng ngôn ngữ
    {
        ...
        prompt: "Some people believe that reading and writing skills are more important today than ever before. To what extent do you agree or disagree?",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Opinion essay. Thí sinh cần liên hệ đến bối cảnh kỹ thuật số hiện đại (mạng xã hội, email, báo cáo công việc…) để làm nổi bật tầm quan trọng của kỹ năng đọc-viết.",
    },
    // 6. Việc làm của Sinh viên
    {
        ...
        prompt: "Many university students take part-time jobs while studying. Does this trend have more advantages or disadvantages for their academic performance?",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: More advantages or disadvantages? Thí sinh nên chọn một lập trường rõ ràng (nghiêng về advantages HOẶC disadvantages) và lập luận nhất quán. Câu kết luận phải trả lời trực tiếp câu hỏi.",
    },
    // 7. Sức khỏe & Lối sống
    {
        ...
        prompt: "Some people think that the government should ban smoking in all public places. Do you agree or disagree with this opinion?",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Agree/Disagree. Lưu ý: Đây là đề có tính tranh luận cao. Thí sinh cần lập luận có chiều sâu, không chỉ nêu quan điểm đơn giản. Được phép đề cập quan điểm đối lập để phản bác (counter-argument).",
    },
    // 8. Mạng xã hội
    {
        ...
        prompt: "Social media has changed the way people communicate and build relationships. Is this a positive or negative development?",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Positive or Negative development? Thí sinh chọn quan điểm rõ ràng. Cần đề cập đến sự thay đổi cụ thể trong giao tiếp (không chỉ nói chung chung), ví dụ: Facebook, Zalo, Instagram.",
    },
    // 9. Du lịch & Văn hóa
    {
        ...
        prompt: "Some people believe that tourism is beneficial because it brings income and jobs. Others argue that it causes environmental damage and cultural loss. Discuss both views.",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Discuss both views. Thí sinh HỌ phải trình bày CẢ HAI phía (lợi ích kinh tế VÀ tác hại môi trường/văn hóa). Bài có thể có hoặc không có phần ý kiến cá nhân ở cuối.",
    },
    // 10. Giáo dục cộng đồng
    {
        ...
        prompt: "Young people should be encouraged to participate in unpaid community service. What are the benefits of this for the individuals and the society?",
        requiredVocabulary: [
        ...
        additionalNotes: "Dạng bài: Benefits essay (chỉ bàn về lợi ích – không yêu cầu cả hai chiều). Thí sinh phải bàn về lợi ích cho CẢ HAI đối tượng: cá nhân (individual) VÀ xã hội (society). Bỏ qua một trong hai bị trừ điểm Task Response.",
    },
];
// ──────────────────────────────────────────────────────────────────────────────
// Main runner
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const cls = yield index_1.Class.findOne({ name: { $regex: /^VSTEP-01-03-26$/i } });
    if (!cls) {
    ...
    if (failed > 0)
        console.log(`❌  Thất bại:   ${failed}/10 bài tập`);
